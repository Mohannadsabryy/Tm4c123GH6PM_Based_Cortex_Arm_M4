...
/*
 * make a Leds Rolling using systick with clk freq 80MHZ using pll to reach this frequency
*/
...
#define SYSCTL_RCC2_SYSDIV_VAL            4
...
void Pll_Init(void){
    ...
    /*I will set SYSDIV bits by 4 in order to divide by 5 to reach 80MHz */
